...
from app.api.v1.endpoints import auth, datasets, projects, annotations, export, image_locks, project_permissions, users, invitations, version_diff, admin_datasets, admin_audit, admin_stats, service_accounts, platform_datasets
...
api_router.include_router(service_accounts.router, prefix="/auth/service-accounts", tags=["Service Accounts"])
