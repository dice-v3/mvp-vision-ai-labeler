...
export default function AddClassModal({ isOpen, onClose, projectId, onClassAdded, currentTask }: AddClassModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const request: ClassCreateRequest = {
        // class_id is auto-generated by the server
        name: className.trim(),
        color: color,
        description: description.trim() || undefined,
      };

      await addClass(projectId, request, currentTask);
