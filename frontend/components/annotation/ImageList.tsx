          ...
          <div className="mt-4 flex justify-center">
            ...
            >
              {(loadingMore || backgroundLoading) ? (
                ...
                <svg className="animate-spin w-full h-full text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24">
                ...
                <>
                  {/* Dashed border */}
                  <div className="absolute inset-0 rounded-full border border-dashed border-gray-300 dark:border-gray-600" />
                  {/* + icon */}
                  <svg
                    className="w-3 h-3 text-gray-400 dark:text-gray-500 relative z-10"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    strokeWidth="2"
